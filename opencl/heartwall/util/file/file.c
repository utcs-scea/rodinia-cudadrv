...
read_parameters(char* filename,
	...
	if( fid == NULL ){
		printf( "The param file was not opened for reading (%s)\n", filename );
		return;
	}
...
read_header(char* filename,
	...
	fid = fopen(filename, "r");
	if( fid == NULL ){
		printf( "The header file was not opened for reading (%s)\n", filename );
		return;
	}
...
read_data(	char* filename,
	...
	fid = fopen(filename, "r");
	if( fid == NULL ){
		printf( "The data file was not opened for reading (%s)\n", filename );
		return;
	}
...
void write_data(	char* filename,
	...
	if( fid == NULL ){
		printf( "The output file was not opened for reading (%s)\n", filename );
		return;
	}
