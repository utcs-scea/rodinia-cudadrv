...
int main(int argc, char * argv[])
{
    {
        struct timeval amd;
        gettimeofday(&amd, NULL);
        printf("start timestamp = %ld s %ld nsec\n", amd.tv_sec, amd.tv_usec * 1000);
    }
    ...
    try {
        ...
        //--gpu entry
        {
            struct timeval amd;
            gettimeofday(&amd, NULL);
            printf("before gpu timestamp = %ld s %ld nsec\n", amd.tv_sec, amd.tv_usec * 1000);
        }
...

        {
            struct timeval amd;
            gettimeofday(&amd, NULL);
            printf("after gpu timestamp = %ld s %ld nsec\n", amd.tv_sec, amd.tv_usec * 1000);
        }
        //---------------------------------------------------------
        //--cpu entry
...

    {
        struct timeval amd;
        gettimeofday(&amd, NULL);
        printf("before exit timestamp = %ld s %ld nsec\n", amd.tv_sec, amd.tv_usec * 1000);
    }
